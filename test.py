...
class GameInstance:
    ...
    def init_net_engine_socket(self):
        while True:
            ...
            try:
                self.net_engine.socket = socket.socket(
...
class TestSync(unittest.TestCase):
    ...
    def test_add_peers_json_groups_candidates(self):
        ...
        engine.add_peers_json(
            '[["203.0.113.1:1234", "10.0.0.10:1234"], ["203.0.113.2:5678", "192.168.1.20:5678"]]'
        )
        self.assertEqual(
            engine.peers, [[("203.0.113.2", 5678), ("192.168.1.20", 5678)]]
        )
